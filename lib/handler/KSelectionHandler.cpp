...
{
    vector<string>::iterator iter = paste_buffer.begin();
...
{
    vector<KSelectable *>::iterator result;
    result = find(selected_selectables.begin(), selected_selectables.end(), selectable);
