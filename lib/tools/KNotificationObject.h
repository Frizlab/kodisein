...
typedef void	 (KObject::*KSetStringPtr)	(const string &);
typedef void	 (KObject::*KSetSizePtr)	(const KSize &);
typedef void *	 (KObject::*KGetDataPtr)	();
typedef float    (KObject::*KGetFloatPtr)   () const;
typedef int	     (KObject::*KGetIntPtr)		() const;
typedef bool     (KObject::*KGetBoolPtr)	() const;
typedef string	 (KObject::*KGetStringPtr)	() const;
typedef KSize	 (KObject::*KGetSizePtr)	() const;
...
{
    int				name;
    vector<KReceiverCallback*>	receiver_callbacks;
...
class KNotificationObject
{
    ...
    vector<KNamedReceiverCallbacks*> named_receiver_callbacks;
    ...
    void	notifyReceivers ( const string &,		int = KDL_NOTIFICATION_TYPE_SET_STRING ) const;
    ...
    bool	receiveValue    ( string *, 			int = KDL_NOTIFICATION_TYPE_GET_STRING ) const;
