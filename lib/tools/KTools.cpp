...
// --------------------------------------------------------------------------------------------------------
void kStrokeString ( const string & str, const KVector & position, void * font )
{
    glPushMatrix();
...
// --------------------------------------------------------------------------------------------------------
void kBitmapString ( const string & str, const KVector & position, void * font )
{
...
// --------------------------------------------------------------------------------------------------------
void kDisplayString ( const string & str, const KVector & position, void * font )
{
    string replaced(str);
...
// --------------------------------------------------------------------------------------------------------
void kDisplayString ( const string & str, const KPosition & pos, bool largeFont )
{
