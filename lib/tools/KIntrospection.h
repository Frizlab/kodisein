...
//    void         getHierarchy( string & ) const;
...
#define TEMPLATE_INFO_DEFINITION(type,className) \
    template <class type> const KClassInfo className<type>::class_info(#className, className ## BaseList);
...
#define TEMPLATE_INTROSPECTION(type,className,base1) \
    INTROSPECTION_BASE_LIST(className,base1) TEMPLATE_INFO_DEFINITION(type,className)

#define TEMPLATE_INTROSPECTION1(type,className,base1) \
    INTROSPECTION_BASE_LIST1(className,base1) TEMPLATE_INFO_DEFINITION(type,className)

#define TEMPLATE_INTROSPECTION2(type,className,base1,base2) \
    INTROSPECTION_BASE_LIST2(className,base1,base2) TEMPLATE_INFO_DEFINITION(type,className)

#define TEMPLATE_INTROSPECTION3(type,className,base1,base2,base3) \
    INTROSPECTION_BASE_LIST3(className,base1,base2,base3) TEMPLATE_INFO_DEFINITION(type,className)
