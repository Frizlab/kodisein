...
KMenuWindow::KMenuWindow () : KWindow ( 0 )
{
    ...
    widget->setBGColor (KColor(0.0, 0.0, 0.0, 0.6f));
...
// --------------------------------------------------------------------------------------------------------
void KMenuWindow::setXML ( string & xml )
{
    if (!kXMLParseNamedOpenTag(xml, "Menu", NULL, false).empty())
    {
...
// --------------------------------------------------------------------------------------------------------
string KMenuWindow::getXML ( int depth ) const
{
    string xml;
