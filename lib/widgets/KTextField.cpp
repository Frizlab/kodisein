...
// --------------------------------------------------------------------------------------------------------
KTextField::KTextField ( const string & n ) : KLabel(n), KKeyHandler()
{
...
// --------------------------------------------------------------------------------------------------------
KTextField * KTextField::firstTextFieldInVector ( const vector<KWidget*> & widgets )
{
    vector<KWidget*>::const_iterator iter = widgets.begin();
...
// --------------------------------------------------------------------------------------------------------
KTextField * KTextField::lastTextFieldInVector ( const vector<KWidget*> & widgets )
{
    vector<KWidget*>::const_reverse_iterator iter = widgets.rbegin();
...
// --------------------------------------------------------------------------------------------------------
void KTextField::setText ( const string & t )
{
    KLabel::setText(t);
...
void KTextField::printf ( const char * fmt ... )
{
    ...
    setText(text + kStringPrintFormArgs(fmt, &argList));
    va_end(argList);
}
...
// --------------------------------------------------------------------------------------------------------
string KTextField::getSelection () const
{
