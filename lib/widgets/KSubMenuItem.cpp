...
// --------------------------------------------------------------------------------------------------------
KSubMenuItem::KSubMenuItem ( const string & nm, KMenu * menu ) : KMenuItem (nm)
{
    child_menu = menu;
}
...
KSize KSubMenuItem::getSize () const
{
    ...
    return KSize(menuItemSize.w + 25.0, menuItemSize.h);
}

// --------------------------------------------------------------------------------------------------------
string KSubMenuItem::getXML ( int depth ) const
{
    string xml;
...
// --------------------------------------------------------------------------------------------------------
void KSubMenuItem::setXML ( string & xml )
{
    string attributes;
