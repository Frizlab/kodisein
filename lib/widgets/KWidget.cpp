...
// --------------------------------------------------------------------------------------------------------
void KWidget::getWidgetsInHierarchy ( vector<KWidget*>* widgets )
{
    PickableVector::iterator iter = children.begin();
    while (iter != children.end())
    {
...
// --------------------------------------------------------------------------------------------------------
vector<KWidget*> KWidget::getChildrenBehindWidget ( KWidget * w )
{
    vector<KWidget*> hierarchy;
    getWidgetsInHierarchy(&hierarchy);
    vector<KWidget*>::iterator result = find(hierarchy.begin(), hierarchy.end(), w);
...
// --------------------------------------------------------------------------------------------------------
vector<KWidget*> KWidget::getChildrenBeforeWidget ( KWidget * w )
{
    vector<KWidget*> hierarchy;
    getWidgetsInHierarchy(&hierarchy);
    vector<KWidget*>::iterator result = find(hierarchy.begin(), hierarchy.end(), w);
...
{
    KPosition vpPos(matrix[TX], matrix[TY]);
