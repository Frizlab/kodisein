...
// --------------------------------------------------------------------------------------------------------
KFileTreeNode::KFileTreeNode ( const string & n ) : KPickable (),  KMatrix ()
{
    name = n;
    parent = NULL;
}
...
// --------------------------------------------------------------------------------------------------------
string KFileTreeNode::getSuffix () const
{
...
// --------------------------------------------------------------------------------------------------------
string KFileTreeNode::getAbsPathName () const
{
    if (parent)
    {
...
// --------------------------------------------------------------------------------------------------------
string KFileTreeNode::getPathName () const
{
    if (parent)
    {
